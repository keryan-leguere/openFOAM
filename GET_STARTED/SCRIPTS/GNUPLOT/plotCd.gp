...
#set output "postProcessing/forceCoeffsIncompressible/0/forceCoeffsIncompressible.eps"

plot "./postProcessing/forceCoeffs_object/0/forceCoeffs.dat" using 1:3 title "Cd" with lines lw 2
