...
set title "OpenFOAM Residuals" font 'Times-Roman, 28'
set xlabel "Time" font 'Courier,24'
...
plot "./postProcessing/residuals/0/residuals.dat" using 1:2 title "Ux" with lines lw 3, \
 "./postProcessing/residuals/0/residuals.dat" using 1:3 title "Uy" with lines lw 3, \
 "./postProcessing/residuals/0/residuals.dat" using 1:4 title "p" with lines lw 3
